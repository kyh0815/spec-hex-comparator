...
(function (root, factory) {
  ...
  var STRINGS = {
    ko: {
      ...
      "pairing.unmatchedCount": "짝 없음 {n}개",
      ...
      "dash.title": "테이블별 비교 결과",
      "dash.subtitle": "총 `{n}`개 테이블 비교. 클릭 가능한 행을 펼치면 레코드별 상세(칼럼값)를 확인할 수 있습니다.",
      "dash.tables": "테이블 {n}",
      "dash.passed": "통과 {n}",
      "dash.failed": "실패 {n}",
      ...
      "batchVerdict.passReason": "전체 **{n}**개 테이블이 **완전 일치**합니다.",
      "batchVerdict.failReason": "테이블 **{n}**개에서 불일치 — 누적 차이 row **{m}**건.",
      "batchVerdict.unpairedNote": "짝 없는 파일 {n}건이 함께 보고됩니다.",
      "batchVerdict.failTablesLabel": "불일치 테이블:",
      "batchVerdict.metaTables": "대상 테이블",
      "batch.metaPassed": "통과",
      "batch.metaFailed": "실패",
      ...
      "pager.prev": "이전",
      "pager.next": "다음",
      "pager.page": "페이지 {cur} / {total}",
      "board.unpairedAsIs": "As-Is에만 존재하는 파일 **{n}개**",
      "board.unpairedToBe": "To-Be에만 존재하는 파일 **{n}개**",
      "th.table": "테이블명",
      "th.result": "이 테이블의 Pass/Fail 판정",
      "th.match": "값이 모두 일치한 레코드 수",
      "th.mismatch": "값이 다른 레코드 수",
      "th.miss": "As-Is에만 존재 (누락)",
      "th.extra": "To-Be에만 존재 (초과)",
      "th.cols": "검사한 칼럼 수",
      "th.delta": "한 건이라도 값이 달랐던 칼럼 수",
      "th.aCount": "As-Is 레코드 수",
      "th.bCount": "To-Be 레코드 수",
      "th.excluded": "비교 제외 컬럼",
      "nav.backToList": "← 목록으로",
      "export.batchButton": "배치 요약 CSV 내보내기",
      "drill.configTitle": "이 테이블 설정",
      "drill.keyLabel": "키 컬럼 (자동 — 클릭해서 변경)",
      "drill.rerun": "이 테이블 재비교",
      "csv.title": "배치 비교 요약 리포트",
      "csv.generatedAt": "생성일시",
      "csv.verdictLabel": "전체 판정",
      "csv.rowsLabel": "누적 레코드",
      "csv.unmatchedSection": "짝 없는 파일",
      "csv.fileColumn": "파일명",
      "csv.sideColumn": "위치",
      "csv.tablesSection": "테이블별 결과",
      "csv.colTable": "테이블",
      "csv.colVerdict": "판정",
      "csv.colTotal": "전체 row",
      "csv.colMatch": "일치",
      "csv.colMismatch": "불일치",
      "csv.colMiss": "누락(As-Is만)",
      "csv.colExtra": "초과(To-Be만)",
      "csv.colCols": "공통 칼럼수",
      "csv.colDiffCols": "차이 칼럼수",
      "csv.colDiffList": "차이 칼럼",
      "csv.colPk": "PK",
      "csv.colExcluded": "제외 칼럼",
      "csv.colACount": "As-Is row",
      "csv.colBCount": "To-Be row"
    },
    ...
    ja: {
      ...
      "pairing.unmatchedCount": "対応なし {n}個",
      ...
      "dash.title": "テーブル別の比較結果",
      "dash.subtitle": "計 `{n}` テーブルを比較。クリック可能な行を展開すると、レコードごとの詳細（カラム値）を確認できます。",
      "dash.tables": "テーブル {n}",
      "dash.passed": "成功 {n}",
      "dash.failed": "失敗 {n}",
      ...
      "batchVerdict.passReason": "全 **{n}** テーブルが **完全一致** しています。",
      "batchVerdict.failReason": "**{n}** テーブルで不一致 — 累積差分 row **{m}**件。",
      "batchVerdict.unpairedNote": "対応のないファイル {n}件も報告されます。",
      "batchVerdict.failTablesLabel": "不一致テーブル:",
      "batchVerdict.metaTables": "対象テーブル",
      "batch.metaPassed": "成功",
      "batch.metaFailed": "失敗",
      ...
      "pager.prev": "前へ",
      "pager.next": "次へ",
      "pager.page": "ページ {cur} / {total}",
      "board.unpairedAsIs": "As-Isにのみ存在するファイル **{n}個**",
      "board.unpairedToBe": "To-Beにのみ存在するファイル **{n}個**",
      "th.table": "テーブル名",
      "th.result": "このテーブルのPass/Fail判定",
      "th.match": "値がすべて一致したレコード数",
      "th.mismatch": "値が異なるレコード数",
      "th.miss": "As-Isのみ (欠落)",
      "th.extra": "To-Beのみ (余剰)",
      "th.cols": "検査カラム数",
      "th.delta": "差異が出たカラム数",
      "th.aCount": "As-Is レコード数",
      "th.bCount": "To-Be レコード数",
      "th.excluded": "比較除外カラム",
      "nav.backToList": "← 一覧へ",
      ...
      "csv.title": "バッチ比較サマリーレポート",
      "csv.generatedAt": "生成日時",
      "csv.verdictLabel": "全体判定",
      "csv.rowsLabel": "累計レコード",
      "csv.unmatchedSection": "ペアなしファイル",
      "csv.fileColumn": "ファイル名",
      "csv.sideColumn": "位置",
      "csv.tablesSection": "テーブル別結果",
      "csv.colTable": "テーブル",
      "csv.colVerdict": "判定",
      "csv.colTotal": "全 row",
      "csv.colMatch": "一致",
      "csv.colMismatch": "不一致",
      "csv.colMiss": "欠落(As-Isのみ)",
      "csv.colExtra": "余剰(To-Beのみ)",
      "csv.colCols": "共通カラム数",
      "csv.colDiffCols": "差異カラム数",
      "csv.colDiffList": "差異カラム",
      "csv.colPk": "PK",
      "csv.colExcluded": "除外カラム",
      "csv.colACount": "As-Is row",
      "csv.colBCount": "To-Be row"
    },
    ...
    en: {
      ...
      "pairing.unmatchedCount": "{n} unpaired",
      ...
      "dash.title": "Per-table comparison results",
      "dash.subtitle": "`{n}` tables compared. Expand a row to inspect each record's detail (column values).",
      ...
      "batchVerdict.passReason": "All **{n}** tables are a **full match**.",
      "batchVerdict.failReason": "**{n}** tables differ — **{m}** total differing rows.",
      "batchVerdict.unpairedNote": "{n} unpaired files are also reported.",
      "batchVerdict.failTablesLabel": "Tables with diffs:",
      "batchVerdict.metaTables": "Tables",
      "batch.metaPassed": "Passed",
      "batch.metaFailed": "Failed",
      ...
      "board.unpairedAsIs": "**{n}** files only in As-Is",
      "board.unpairedToBe": "**{n}** files only in To-Be",
      "th.table": "Table name",
      "th.result": "Pass/Fail verdict for this table",
      "th.match": "Records that fully match",
      "th.mismatch": "Records with differing values",
      "th.miss": "Only in As-Is (missing)",
      "th.extra": "Only in To-Be (extra)",
      "th.cols": "Columns compared",
      "th.delta": "Columns with any difference",
      "th.aCount": "As-Is records",
      "th.bCount": "To-Be records",
      "th.excluded": "Excluded columns",
      ...
      "csv.title": "Batch comparison summary report",
      "csv.generatedAt": "Generated at",
      "csv.verdictLabel": "Overall verdict",
      "csv.rowsLabel": "Total records",
      "csv.unmatchedSection": "Unmatched files",
      "csv.fileColumn": "File",
      "csv.sideColumn": "Side",
      "csv.tablesSection": "Per-table results",
      "csv.colTable": "Table",
      "csv.colVerdict": "Verdict",
      "csv.colTotal": "Total rows",
      "csv.colMatch": "Match",
      "csv.colMismatch": "Mismatch",
      "csv.colMiss": "Missing (As-Is only)",
      "csv.colExtra": "Extra (To-Be only)",
      "csv.colCols": "Common cols",
      "csv.colDiffCols": "Diff cols",
      "csv.colDiffList": "Diff columns",
      "csv.colPk": "PK",
      "csv.colExcluded": "Excluded cols",
      "csv.colACount": "As-Is rows",
      "csv.colBCount": "To-Be rows"
    }
  };
