...
(function (root, factory) {
  ...
  var STRINGS = {
    ko: {
      ...
      "upload.pickFolder": "폴더 선택",
      "upload.pickFiles": "파일 선택",
      "drop.batchEmptyName": "폴더 또는 CSV들을 끌어 놓거나 클릭",
      "drop.batchEmptyHint": ".csv만 수집 · 파일명으로 자동 페어링",
      "drop.filesLoaded": "{n}개 CSV",
      "pairing.title": "페어링",
      "pairing.matched": "매칭 {n}쌍",
      "pairing.onlyAsIsLabel": "As-Is에만",
      "pairing.onlyToBeLabel": "To-Be에만",
      "pairing.none": "매칭된 쌍이 없습니다. 파일명이 양쪽 동일한지 확인하세요.",
      "run.batchButton": "전체 비교 실행",
      "run.batchHint": "As-Is·To-Be 양쪽에 파일을 올리세요",
      "dash.title": "비교 대시보드",
      "dash.subtitle": "테이블별 비교 결과. 행을 클릭하면 세부 증거를 확인합니다.",
      "dash.tables": "테이블 {n}",
      "dash.passed": "통과 {n}",
      "dash.failed": "실패 {n}",
      "dash.unmatched": "미매칭 {n}",
      "dash.colTable": "테이블",
      "dash.colResult": "판정",
      "dash.unmatchedTitle": "짝 없는 파일 ({n})",
      "dash.cols": "칼럼",
      "dash.diffCols": "차이 칼럼",
      "pairing.excludeHint": "클릭해서 비교에서 제외/포함",
      "nav.backToList": "← 목록으로",
      "export.batchButton": "배치 요약 CSV 내보내기",
      "drill.configTitle": "이 테이블 설정",
      "drill.keyLabel": "키 컬럼 (자동 — 클릭해서 변경)",
      "drill.rerun": "이 테이블 재비교"
    },
    ...
    ja: {
      ...
      "upload.pickFolder": "フォルダを選択",
      "upload.pickFiles": "ファイルを選択",
      "drop.batchEmptyName": "フォルダまたはCSVをドラッグ、またはクリック",
      "drop.batchEmptyHint": ".csvのみ収集 · ファイル名で自動ペアリング",
      "drop.filesLoaded": "{n}件のCSV",
      "pairing.title": "ペアリング",
      "pairing.matched": "マッチ {n}組",
      "pairing.onlyAsIsLabel": "As-Isのみ",
      "pairing.onlyToBeLabel": "To-Beのみ",
      "pairing.none": "マッチした組がありません。両側のファイル名が同一か確認してください。",
      "run.batchButton": "一括比較を実行",
      "run.batchHint": "As-Is・To-Beの両方にファイルをアップロードしてください",
      "dash.title": "比較ダッシュボード",
      "dash.subtitle": "テーブル別の比較結果。行をクリックすると詳細な根拠を確認できます。",
      "dash.tables": "テーブル {n}",
      "dash.passed": "成功 {n}",
      "dash.failed": "失敗 {n}",
      "dash.unmatched": "未マッチ {n}",
      "dash.colTable": "テーブル",
      "dash.colResult": "判定",
      "dash.unmatchedTitle": "対応のないファイル ({n})",
      "dash.cols": "カラム",
      "dash.diffCols": "差異カラム",
      "pairing.excludeHint": "クリックで比較から除外/含める",
      "nav.backToList": "← 一覧へ",
      "export.batchButton": "一括サマリーCSVを書き出す",
      "drill.configTitle": "このテーブルの設定",
      "drill.keyLabel": "キーカラム (自動 — クリックで変更)",
      "drill.rerun": "このテーブルを再比較"
    },
    ...
    en: {
      ...
      "upload.pickFolder": "Select folder",
      "upload.pickFiles": "Select files",
      "drop.batchEmptyName": "Drag a folder or CSVs here, or click",
      "drop.batchEmptyHint": "Collects .csv only · auto-paired by filename",
      "drop.filesLoaded": "{n} CSV files",
      "pairing.title": "Pairing",
      "pairing.matched": "{n} matched pairs",
      "pairing.onlyAsIsLabel": "As-Is only",
      "pairing.onlyToBeLabel": "To-Be only",
      "pairing.none": "No matched pairs. Check that filenames are identical on both sides.",
      "run.batchButton": "Run all comparisons",
      "run.batchHint": "Upload files to both As-Is and To-Be",
      "dash.title": "Comparison dashboard",
      "dash.subtitle": "Per-table results. Click a row to see detailed evidence.",
      "dash.tables": "{n} tables",
      "dash.passed": "{n} passed",
      "dash.failed": "{n} failed",
      "dash.unmatched": "{n} unmatched",
      "dash.colTable": "Table",
      "dash.colResult": "Verdict",
      "dash.unmatchedTitle": "Unmatched files ({n})",
      "dash.cols": "Columns",
      "dash.diffCols": "Diff cols",
      "pairing.excludeHint": "Click to exclude/include from comparison",
      "nav.backToList": "← Back to list",
      "export.batchButton": "Export batch summary CSV",
      "drill.configTitle": "This table's settings",
      "drill.keyLabel": "Key columns (auto — click to change)",
      "drill.rerun": "Re-compare this table"
    }
  };
